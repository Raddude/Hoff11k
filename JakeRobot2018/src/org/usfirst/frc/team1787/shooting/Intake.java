...
public class Intake {
	...
	private WPI_TalonSRX intakeRight = new WPI_TalonSRX(INTAKE_MASTER_TALON_ID);
	private WPI_VictorSPX intakeLeft = new WPI_VictorSPX(INTAKE_FOLLOWER_VICTOR_ID);
	...
	public void pushDataToShuffleboard() {
		...
		SmartDashboard.putNumber("Right Intake Motor Speed: ", intakeRight.get());
		SmartDashboard.putNumber("Left Intake Motor Speed: ", intakeLeft.get());
	}
